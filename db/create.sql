...
CREATE TABLE Users (
    ...
    firstname VARCHAR(255), -- Changed from NOT NULL to NULL so that Charities can be in Users table
    lastname VARCHAR(255) -- Changed from NOT NULL to NULL so that Charities can be in Users table
);
